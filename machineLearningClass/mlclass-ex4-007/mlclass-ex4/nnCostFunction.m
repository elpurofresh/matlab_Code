...
%First we obtain h_theta(x) = a3 since it is a neural network with 3 layers
a1 = [ones(m, 1) X];
...
%y_matrix(y, :); % (y,:) creates a new matrix, using your y vector as 
                % the row index, and ':' (read as "all columns") of 
                % the Identity matrix.
